...
do
    echo $f
    python filter_by_qname_sam.py -i ${input_folder}/${f}_${THR}.sam -o ${input_folder}/${f}_${THR}_noninformative.sam --qnames ${input_results_folder}/index_${f}_${THR}_noninformative.csv --keep --verbose
